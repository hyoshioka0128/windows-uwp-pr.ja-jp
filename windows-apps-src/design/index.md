...
ms.locfileid: "65135551"
---
# <a name="design-and-code-windows-apps"></a><span data-ttu-id="85001-104">Windows アプリの設計とコーディング</span><span class="sxs-lookup"><span data-stu-id="85001-104">Design and code Windows apps</span></span>

![ヒーロー イメージ](images/ficon-1x.png)

<span data-ttu-id="85001-106">Windows 10 でアプリのエクスペリエンスを作成するための Fluent Design ガイドラインと UI のコード例</span><span class="sxs-lookup"><span data-stu-id="85001-106">Fluent Design guidelines and UI code examples for creating app experiences on Windows 10.</span></span>
...
:::row:::
    :::column:::
       ...
       <span data-ttu-id="85001-107">すべての画面サイズで適切に表示される UI の応答性に関するヒントと API。</span><span class="sxs-lookup"><span data-stu-id="85001-107">Responsive tips and APIs for a UI that looks great on every screen size.</span></span> 
       <br/>
    :::column-end:::
    :::column:::
